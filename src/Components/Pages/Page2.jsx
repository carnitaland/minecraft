    ...
    return(
        ...
        <Fragment>
            <div className="logo2">
                ...
                <div className="logo2">
                    <h1 style={style.title}>REGLAMENTOS</h1>
                </div>

                <p style={style.borders}>
                   <div >
                       <h2>VAYAMOS PRIMERO POR LO LINDO</h2>
                   </div>
                    ...
                    <div>
                        <h2>Y AHORA VAYAMOS POR LA PARTE FEA</h2>
                    </div>
                    ...
                    <div>
                        <h2>TODAS LA NORMAS QUEDAN SUJETAS A CAMBIOS CON EL TIEMPO </h2>
                    </div>
